package my.book.musicplayer.service;

import java.io.IOException;
import java.text.SimpleDateFormat;
import java.util.Date;

import my.book.musicplayer.PlayMusicActivity;
import my.book.musicplayer.db.DatabaseHelper;
...
public class MusicService extends Service implements MediaPlayer.OnCompletionListener {
	...
	private DatabaseHelper dbHelper = null;// ��ݿ����
	private int flag;// ��ʶ
	...
	private void DBOperate(int pos) {
		dbHelper = new DatabaseHelper(this, "music.db", null, 2);
