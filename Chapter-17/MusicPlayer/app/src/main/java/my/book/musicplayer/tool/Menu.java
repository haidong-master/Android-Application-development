...
import my.book.musicplayer.adapter.MenuAdapter;
...
public class Menu {
	...
	private List<GridView> contents;// ��ǩGridView
	private List<List<int[]>> datas;// 0��ͼ�꣬1������
	private List<TextView> tabs;// ��ǩ����
	private int index = 0;// ��ʾ��ǩ����
 ...
 */
	...
	public PopupWindow create() {
		...
		//mPopupWindow.setBackgroundDrawable(new BitmapDrawable()); // ��Ӧ���ؼ����������
		//���߼��ϰ�����Ӧ��popupwindow��view���� setOnKeyListener�����ܽ����
